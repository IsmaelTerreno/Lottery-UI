...
export const BASE_END_POINT_JOB= process.env.REACT_APP_BASE_END_POINT_JOB;
...
export const NAMESPACE_ID_JWT_AUTH_CONFIG = process.env.REACT_APP_NAMESPACE_ID_JWT_AUTH_CONFIG
